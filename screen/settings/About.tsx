...
const About: React.FC = () => {
  ...
  const handleOnTwitterPress = () => {
    Linking.openURL('https://x.com/elarawallet');
  };

  const handleOnDiscordPress = () => {
    Linking.openURL('https://discord.gg/cdsYPnjS4a');
  };

  const handleOnTelegramPress = () => {
    Linking.openURL('https://t.me/elarawallet');
  };

  const handleOnGithubPress = () => {
    Linking.openURL('https://github.com/ElaraWallet/ElaraWallet');
  };

  const handleOnRatePress = () => {
    const options = {
      AppleAppID: '1376878040',
      GooglePackageName: 'org.interchained.elara',
    ...
    <SafeAreaScrollView testID="AboutScrollView" contentInsetAdjustmentBehavior="automatic" automaticallyAdjustContentInsets>
      ...
      <BlueCard>
        <View style={[styles.buildWith, stylesHook.buildWith]}>
          ...
          <BlueTextCentered>interchainedjs-lib</BlueTextCentered>
