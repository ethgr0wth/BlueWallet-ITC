...
describe('unit - encryption', function () {
  ...
  it('handles ok malformed data', function () {
    const decrypted = c.decrypt(
      '',
      'fakePassword',
    );
    assert.ok(!decrypted);
  });
