...
describe.each(['', '//'])('unit - DeepLinkSchemaMatch', function (suffix) {
  it('hasSchema', () => {
    assert.ok(DeeplinkSchemaMatch.hasSchema(`interchained:${suffix}12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG`));
    assert.ok(DeeplinkSchemaMatch.hasSchema(`interchained:${suffix}bc1qh6tf004ty7z7un2v5ntu4mkf630545gvhs45u7?amount=666&label=Yo`));
    assert.ok(DeeplinkSchemaMatch.hasSchema(`interchained:${suffix}BC1QH6TF004TY7Z7UN2V5NTU4MKF630545GVHS45U7?amount=666&label=Yo`));
    assert.ok(DeeplinkSchemaMatch.hasSchema(`INTERCHAINED:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE`));
    assert.ok(DeeplinkSchemaMatch.hasSchema(`INTERCHAINED:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo`));
    assert.ok(
    ...
    assert.ok(DeeplinkSchemaMatch.hasSchema(`bluewallet:interchained:${suffix}12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG`));
    assert.ok(DeeplinkSchemaMatch.hasSchema(`bluewallet:interchained:${suffix}bc1qh6tf004ty7z7un2v5ntu4mkf630545gvhs45u7?amount=666&label=Yo`));
    assert.ok(DeeplinkSchemaMatch.hasSchema(`bluewallet:interchained:${suffix}BC1QH6TF004TY7Z7UN2V5NTU4MKF630545GVHS45U7?amount=666&label=Yo`));
    assert.ok(DeeplinkSchemaMatch.hasSchema(`bluewallet:INTERCHAINED:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE`));
    assert.ok(DeeplinkSchemaMatch.hasSchema(`bluewallet:INTERCHAINED:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo`));
    assert.ok(
      DeeplinkSchemaMatch.hasSchema(
  ...
  it('isInterchained Address', () => {
    assert.ok(DeeplinkSchemaMatch.isInterchainedAddress('12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG'));
    assert.ok(DeeplinkSchemaMatch.isInterchainedAddress('3GcKN7q7gZuZ8eHygAhHrvPa5zZbG5Q1rK'));
    assert.ok(DeeplinkSchemaMatch.isInterchainedAddress('bc1qykcp2x3djgdtdwelxn9z4j2y956npte0a4sref'));
    assert.ok(DeeplinkSchemaMatch.isInterchainedAddress('BC1QYKCP2X3DJGDTDWELXN9Z4J2Y956NPTE0A4SREF'));
    assert.ok(DeeplinkSchemaMatch.isInterchainedAddress(`interchained:${suffix}BC1QH6TF004TY7Z7UN2V5NTU4MKF630545GVHS45U7`));
    assert.ok(DeeplinkSchemaMatch.isInterchainedAddress(`INTERCHAINED:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE`));
    assert.ok(DeeplinkSchemaMatch.isInterchainedAddress(`INTERCHAINED:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo`));
  });
  ...
  it('isBoth Interchained & Invoice', () => {
    assert.ok(
      DeeplinkSchemaMatch.isBothInterchainedAndLightning(
        `interchained:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=0.000001&lightning=lnbc1u1pwry044pp53xlmkghmzjzm3cljl6729cwwqz5hhnhevwfajpkln850n7clft4sdqlgfy4qv33ypmj7sj0f32rzvfqw3jhxaqcqzysxq97zvuq5zy8ge6q70prnvgwtade0g2k5h2r76ws7j2926xdjj2pjaq6q3r4awsxtm6k5prqcul73p3atveljkn6wxdkrcy69t6k5edhtc6q7lgpe4m5k4`,
      ),
    );
    assert.ok(
      DeeplinkSchemaMatch.isBothInterchainedAndLightning(
        `INTERCHAINED:${suffix}12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG?amount=0.000001&lightning=lnbc1u1pwry044pp53xlmkghmzjzm3cljl6729cwwqz5hhnhevwfajpkln850n7clft4sdqlgfy4qv33ypmj7sj0f32rzvfqw3jhxaqcqzysxq97zvuq5zy8ge6q70prnvgwtade0g2k5h2r76ws7j2926xdjj2pjaq6q3r4awsxtm6k5prqcul73p3atveljkn6wxdkrcy69t6k5edhtc6q7lgpe4m5k4`,
      ),
    );

    const rez = DeeplinkSchemaMatch.isBothInterchainedAndLightning(
      `interchained:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=0.000001&lightning=lnbc1u1pwry044pp53xlmkghmzjzm3cljl6729cwwqz5hhnhevwfajpkln850n7clft4sdqlgfy4qv33ypmj7sj0f32rzvfqw3jhxaqcqzysxq97zvuq5zy8ge6q70prnvgwtade0g2k5h2r76ws7j2926xdjj2pjaq6q3r4awsxtm6k5prqcul73p3atveljkn6wxdkrcy69t6k5edhtc6q7lgpe4m5k4`,
    );
    assert.strictEqual(rez.interchained, 'interchained:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=0.000001&');
    assert.strictEqual(
      rez.lndInvoice,
    ...
    // no amount
    const rez4 = DeeplinkSchemaMatch.isBothInterchainedAndLightning(
      `interchained:bc1q8flg3jcnv6x6mpjrqty8h8h9mg0shgp5jc9smk?lightning=`,
    );
    assert.strictEqual(rez4.interchained, 'interchained:bc1q8flg3jcnv6x6mpjrqty8h8h9mg0shgp5jc9smk?');
    assert.strictEqual(
      rez4.lndInvoice,
      'lightning:',
    );
  ...
  it('navigationForRoute', async () => {
    const events = [
      ...
      {
        argument: { url: `interchained:${suffix}12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG` },
        expected: ['SendDetailsRoot', { screen: 'SendDetails', params: { uri: 'interchained:12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG' } }],
      },
      {
        argument: { url: `INTERCHAINED:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo` },
        expected: [
          'SendDetailsRoot',
          { screen: 'SendDetails', params: { uri: 'INTERCHAINED:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo' } },
        ],
      },
      {
        argument: { url: `bluewallet:INTERCHAINED:${suffix}BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo` },
        expected: [
          'SendDetailsRoot',
          { screen: 'SendDetails', params: { uri: 'INTERCHAINED:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo' } },
        ],
    ...
    const rez = await asyncNavigationRouteFor({
      url: `interchained:${suffix}1DamianM2k8WfNEeJmyqSe2YW1upB7UATx?amount=0.000001&lightning=lnbc1u1pwry044pp53xlmkghmzjzm3cljl6729cwwqz5hhnhevwfajpkln850n7clft4sdqlgfy4qv33ypmj7sj0f32rzvfqw3jhxaqcqzysxq97zvuq5zy8ge6q70prnvgwtade0g2k5h2r76ws7j2926xdjj2pjaq6q3r4awsxtm6k5prqcul73p3atveljkn6wxdkrcy69t6k5edhtc6q7lgpe4m5k4`,
    });
  ...
  it('decodes bip21', () => {
    let decoded = DeeplinkSchemaMatch.bip21decode(`interchained:${suffix}1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH?amount=20.3&label=Foobar`);
    ...
    decoded = DeeplinkSchemaMatch.bip21decode(
      `interchained:${suffix}bc1qnapskphjnwzw2w3dk4anpxntunc77v6qrua0f7?amount=0.0001&pj=https://btc.donate.kukks.org/ITC/pj`,
    );
    assert.strictEqual(decoded.options.pj, 'https://btc.donate.kukks.org/ITC/pj');

    decoded = DeeplinkSchemaMatch.bip21decode(`INTERCHAINED:${suffix}1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH?amount=20.3&label=Foobar`);
    assert.deepStrictEqual(decoded, {
      address: '1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH',
      options: {
        amount: 20.3,
  ...
  it('encodes bip21', () => {
    ...
    assert.strictEqual(encoded, 'interchained:1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH');
    encoded = DeeplinkSchemaMatch.bip21encode('1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH', {
      amount: 20.3,
      label: 'Foobar',
    });
    assert.strictEqual(encoded, 'interchained:1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH?amount=20.3&label=Foobar');
  });
  ...
  it('can decodeInterchainedUri', () => {
    assert.deepStrictEqual(
      DeeplinkSchemaMatch.decodeInterchainedUri(
        `interchained:${suffix}bc1qnapskphjnwzw2w3dk4anpxntunc77v6qrua0f7?amount=0.0001&pj=https://btc.donate.kukks.org/ITC/pj`,
      ),
      {
        ...
        amount: 0.0001,
        memo: '',
        payjoinUrl: 'https://btc.donate.kukks.org/ITC/pj',
      },
    );

    assert.deepStrictEqual(
      DeeplinkSchemaMatch.decodeInterchainedUri(`INTERCHAINED:${suffix}1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH?amount=20.3&label=Foobar`),
      {
        address: '1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH',
        amount: 20.3,
        memo: 'Foobar',
    ...
    const navigationMock2 = {
      ...
      navigate: (...args) => {
        ...
        assert.deepStrictEqual(args, [
          ...
          {
            params: {
              uri: 'interchained:BC1QR7P8NSYPZEJY4KP7CJS0HL5T9X0VF3AYF6UQPC?amount=0.00185579&',
