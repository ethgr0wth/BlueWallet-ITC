...
describe.each(['', '//'])('unit - DeepLinkSchemaMatch', function (suffix) {
  ...
  it('isInterchained Address', () => {
    ...
    assert.ok(DeeplinkSchemaMatch.isInterchainedAddress('BC1QYKCP2X3DJGDTDWELXN9Z4J2Y956NPTE0A4SREF'));
    assert.ok(DeeplinkSchemaMatch.isInterchainedAddress(`bitcoin:${suffix}BC1QH6TF004TY7Z7UN2V5NTU4MKF630545GVHS45U7`));
  ...
  it('decodes bip21', () => {
    ...
    decoded = DeeplinkSchemaMatch.bip21decode(
      `bitcoin:${suffix}bc1qnapskphjnwzw2w3dk4anpxntunc77v6qrua0f7?amount=0.0001&pj=https://btc.donate.kukks.org/ITC/pj`,
    );
